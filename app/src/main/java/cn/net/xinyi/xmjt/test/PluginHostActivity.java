    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_orc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                OcrUtils.getInstance(PluginHostActivity.this, new DefaultCallBack() {
                    @Override
        ...
        tv_orc_plate_uninstall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(PluginHostActivity.this, "车牌卸载：" + uninstall, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        tv_orc_idcard_uninstall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(PluginHostActivity.this, "证件卸载：" + uninstall, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        tv_go.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PluginHostActivity.this, PluginHostActivity.class);
